...
/*************************************************************************************************/
  ...
  /********************************    TRI    *********************************/
    ...
    /* you can change the tricopter servo travel here */
      #define TRI_YAW_CONSTRAINT_MIN 1150
      #define TRI_YAW_CONSTRAINT_MAX 1850
  ...
  /***********************          Cam Stabilisation             ***********************/
    ...
    #define TILT_ROLL_MIN     1150
    #define TILT_ROLL_MAX     1850
...
/*************************************************************************************************/
  ...
  /**************************************************************************************/
   ...
   /* GPS protocol 
    ...
    #define MAG_DECLINIATION  10.0f

    #define GPS_LEAD_FILTER                      // Adds a forward predictive filterig to compensate gps lag. Code based on Jason Short's lead filter implementation
    
    //#define GPS_FILTERING                        // add a 5 element moving average filter to GPS coordinates, helps eliminate gps noise but adds latency comment out to disable
    #define GPS_WP_RADIUS              300       // if we are within this distance to a waypoint then we consider it reached (distance is in cm)
  ...
  /**************************************************************************************/
    ...
    #define LCD_TELEMETRY_STEP "01347" // should contain a 0 to allow switching off.
  ...
  /********************************************************************/
     ...
     */
    #define BOARD_NAME "ArduinoBoard-.--"
    //                  123456789.123456
